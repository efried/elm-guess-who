...
var $author$project$Main$allCards = _List_fromArray(
	[
		{faceUp: true, imageUrl: './assets/images/alex.png', name: 'alex'},
		{faceUp: true, imageUrl: './assets/images/alfred.png', name: 'alfred'},
		{faceUp: true, imageUrl: './assets/images/anita.png', name: 'anita'},
		{faceUp: true, imageUrl: './assets/images/anne.png', name: 'anne'},
		{faceUp: true, imageUrl: './assets/images/bernard.png', name: 'bernard'},
		{faceUp: true, imageUrl: './assets/images/bill.png', name: 'bill'},
		{faceUp: true, imageUrl: './assets/images/charles.png', name: 'charles'},
		{faceUp: true, imageUrl: './assets/images/claire.png', name: 'claire'},
		{faceUp: true, imageUrl: './assets/images/david.png', name: 'david'},
		{faceUp: true, imageUrl: './assets/images/eric.png', name: 'eric'},
		{faceUp: true, imageUrl: './assets/images/frans.png', name: 'frans'},
		{faceUp: true, imageUrl: './assets/images/george.png', name: 'george'},
		{faceUp: true, imageUrl: './assets/images/herman.png', name: 'herman'},
		{faceUp: true, imageUrl: './assets/images/joe.png', name: 'joe'},
		{faceUp: true, imageUrl: './assets/images/maria.png', name: 'maria'},
		{faceUp: true, imageUrl: './assets/images/max.png', name: 'max'},
		{faceUp: true, imageUrl: './assets/images/paul.png', name: 'paul'},
		{faceUp: true, imageUrl: './assets/images/peter.png', name: 'peter'},
		{faceUp: true, imageUrl: './assets/images/philip.png', name: 'philip'},
		{faceUp: true, imageUrl: './assets/images/richard.png', name: 'richard'},
		{faceUp: true, imageUrl: './assets/images/robert.png', name: 'robert'},
		{faceUp: true, imageUrl: './assets/images/sam.png', name: 'sam'},
		{faceUp: true, imageUrl: './assets/images/susan.png', name: 'susan'},
		{faceUp: true, imageUrl: './assets/images/tom.png', name: 'tom'}
	]);
	...
	return _Utils_Tuple2(
		{
			cards: $elm$core$Dict$fromList(
				A2(
					$elm$core$List$map,
					function (person) {
						return _Utils_Tuple2(person.name, person);
					},
					$author$project$Main$allCards)),
			selectedCard: $elm$core$Maybe$Nothing
		},
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Main$PickCard = {$: 'PickCard'};
		...
		return A2(
			...
			_List_Nil,
			{
				label: card.faceUp ? A2(
					...
					{description: card.name, src: card.imageUrl}) : A2(
				...
				onPress: clickable ? $elm$core$Maybe$Just(
					$author$project$Main$CardClicked(card.name)) : $elm$core$Maybe$Just($author$project$Main$NoOp)
			});
	});
			...
			_List_fromArray(
				[
						...
						[$mdgriffith$elm_ui$Element$centerX]),
					{
						...
						onPress: $elm$core$Maybe$Just($author$project$Main$PickCard)
					})
				]));
	} else {
		return A2(
			...
			A2(
				...
				_List_fromArray(
					[$mdgriffith$elm_ui$Element$centerX]),
				{
					label: $mdgriffith$elm_ui$Element$text('Choose Card'),
					onPress: $elm$core$Maybe$Just($author$project$Main$PickCard)
				}));
	}
};
...
var $author$project$Main$viewCardRows = function (model) {
	return A2(
		...
		A2(
			...
			6,
			$elm$core$Dict$values(model.cards)));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"PickCard":[],"ResetBoard":["Basics.Int"],"CardClicked":["String.String"],"NoOp":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));