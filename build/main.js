// elm-watch hot {"version":"1.1.2","targetName":"My target name","webSocketPort":62707}
"use strict";
(() => {
...
function _Platform_initialize(programType, isDebug, debugMetadata, flagDecoder, args, init, impl, stepperBuilder)
{
	...
	function setUpdateAndSubscriptions() {
		update = impl.dq || impl._impl.dq;
		subscriptions = impl.c6 || impl._impl.c6;
		if (isDebug) {
	...
	return _Platform_initialize(
		...
		function(sendToApp, initialModel) {
			...
			return _Browser_makeAnimator(initialModel, function(model)
			{
				...
				var nextNode = impl.dr(model); // added by elm-watch
	...
	return _Platform_initialize(
		...
		function(sendToApp, initialModel) {
			...
			return _Browser_makeAnimator(initialModel, function(model)
			{
				...
				var doc = impl.dr(model); // added by elm-watch
...
function _Browser_application(impl)
{
	...
	var key = function() { key.a(impl.cK(_Browser_getUrl())); }; // added by elm-watch
	...
	return _Browser_document({
		...
		cy: function(flags)
		{
			...
			return A3(impl.cy, flags, globalThis.__ELM_WATCH.INIT_URL, key); // added by elm-watch
		},
		...
		dr: function(model) { return impl.dr(model); }, // added by elm-watch
...
var $author$project$Main$allCards = _List_fromArray(
	[
		{b: true, d: './assets/images/alex.png', c: 'alex'},
		{b: true, d: './assets/images/alfred.png', c: 'alfred'},
		{b: true, d: './assets/images/anita.png', c: 'anita'},
		{b: true, d: './assets/images/anne.png', c: 'anne'},
		{b: true, d: './assets/images/bernard.png', c: 'bernard'},
		{b: true, d: './assets/images/bill.png', c: 'bill'},
		{b: true, d: './assets/images/charles.png', c: 'charles'},
		{b: true, d: './assets/images/claire.png', c: 'claire'},
		{b: true, d: './assets/images/david.png', c: 'david'},
		{b: true, d: './assets/images/eric.png', c: 'eric'},
		{b: true, d: './assets/images/frans.png', c: 'frans'},
		{b: true, d: './assets/images/george.png', c: 'george'},
		{b: true, d: './assets/images/herman.png', c: 'herman'},
		{b: true, d: './assets/images/joe.png', c: 'joe'},
		{b: true, d: './assets/images/maria.png', c: 'maria'},
		{b: true, d: './assets/images/max.png', c: 'max'},
		{b: true, d: './assets/images/paul.png', c: 'paul'},
		{b: true, d: './assets/images/peter.png', c: 'peter'},
		{b: true, d: './assets/images/philip.png', c: 'philip'},
		{b: true, d: './assets/images/richard.png', c: 'richard'},
		{b: true, d: './assets/images/robert.png', c: 'robert'},
		{b: true, d: './assets/images/sam.png', c: 'sam'},
		{b: true, d: './assets/images/susan.png', c: 'susan'},
		{b: true, d: './assets/images/tom.png', c: 'tom'}
	]);
	...
	return _Utils_Tuple2(
		{
			N: $elm$core$Dict$fromList(
				A2(
					$elm$core$List$map,
					function (person) {
						return _Utils_Tuple2(person.c, person);
					},
					$author$project$Main$allCards)),
				...
				return _Utils_Tuple2(
					{
						...
						ax: A2(
							$elm$core$Array$get,
							idx,
							$elm$core$Array$fromList($author$project$Main$allCards))
					},
					$elm$core$Platform$Cmd$none);
			case 2:
				var name = msg.a;
...
var $mdgriffith$elm_ui$Internal$Model$asColumn = 1;
var $mdgriffith$elm_ui$Internal$Style$classes = {bM: 'a', aA: 'atv', bO: 'ab', bP: 'cx', bQ: 'cy', bR: 'acb', bS: 'accx', bT: 'accy', bU: 'acr', a_: 'al', a$: 'ar', bV: 'at', aB: 'ah', aC: 'av', bX: 's', b$: 'bh', b0: 'b', b2: 'w7', b4: 'bd', b5: 'bdt', an: 'bn', b6: 'bs', ao: 'cpe', cc: 'cp', cd: 'cpx', ce: 'cpy', G: 'c', aq: 'ctr', ar: 'cb', as: 'ccx', H: 'ccy', ag: 'cl', at: 'cr', cg: 'ct', ch: 'cptr', ci: 'ctxt', cp: 'fcs', a6: 'focus-within', cq: 'fs', cr: 'g', aH: 'hbh', aI: 'hc', ba: 'he', aJ: 'hf', bb: 'hfp', ct: 'hv', cv: 'ic', cx: 'fr', av: 'lbl', cz: 'iml', cA: 'imlf', cB: 'imlp', cC: 'implw', cD: 'it', cE: 'i', bg: 'lnk', aa: 'nb', bj: 'notxt', cI: 'ol', cJ: 'or', T: 'oq', cN: 'oh', bn: 'pg', bo: 'p', cO: 'ppe', cR: 'ui', x: 'r', cT: 'sb', cU: 'sbx', cV: 'sby', cW: 'sbt', cY: 'e', cZ: 'cap', c_: 'sev', c4: 'sk', s: 't', c7: 'tc', c8: 'w8', c9: 'w2', da: 'w9', db: 'tj', ay: 'tja', dc: 'tl', dd: 'w3', de: 'w5', df: 'w4', dg: 'tr', dh: 'w6', di: 'w1', dj: 'tun', bC: 'ts', W: 'clr', dp: 'u', aV: 'wc', bH: 'we', aW: 'wf', bI: 'wfp', aY: 'wrp'};
var $mdgriffith$elm_ui$Internal$Model$Generic = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$div = $mdgriffith$elm_ui$Internal$Model$Generic;
var $mdgriffith$elm_ui$Internal$Model$NoNearbyChildren = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.bX + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.G);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.A)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.c$.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.c$.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.x) + ('-' + ($elm$core$String$fromInt(pos.cf) + ('-' + ($elm$core$String$fromInt(pos.bG) + ('-' + $elm$core$String$fromInt(pos.a9)))))));
		case 11:
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bX) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.x) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bX) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bX) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.x) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bX) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.aq) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
	...
	function (options, rule, maybePseudo) {
		switch (rule.$) {
			...
			case 9:
				...
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.x) + ('-' + ($elm$core$String$fromInt(position.cf) + ('-' + ($elm$core$String$fromInt(position.bG) + ('-' + $elm$core$String$fromInt(position.a9)))))));
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {a9: height / size, ab: size, bE: vertical};
	});
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.bX, $mdgriffith$elm_ui$Internal$Style$classes.cY, $mdgriffith$elm_ui$Internal$Style$classes.aq, $mdgriffith$elm_ui$Internal$Style$classes.H, $mdgriffith$elm_ui$Internal$Style$classes.bU])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.bX, $mdgriffith$elm_ui$Internal$Style$classes.cY, $mdgriffith$elm_ui$Internal$Style$classes.aq, $mdgriffith$elm_ui$Internal$Style$classes.H, $mdgriffith$elm_ui$Internal$Style$classes.bS])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.bX, $mdgriffith$elm_ui$Internal$Style$classes.cY, $mdgriffith$elm_ui$Internal$Style$classes.aq, $mdgriffith$elm_ui$Internal$Style$classes.bT])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.bX, $mdgriffith$elm_ui$Internal$Style$classes.cY, $mdgriffith$elm_ui$Internal$Style$classes.aq, $mdgriffith$elm_ui$Internal$Style$classes.bR])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.bX + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.s + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aV + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aI)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.bX + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.s + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aW + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aJ)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aa, $mdgriffith$elm_ui$Internal$Style$classes.cY, $mdgriffith$elm_ui$Internal$Style$classes.bM]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aa, $mdgriffith$elm_ui$Internal$Style$classes.cY, $mdgriffith$elm_ui$Internal$Style$classes.b0]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aa, $mdgriffith$elm_ui$Internal$Style$classes.cY, $mdgriffith$elm_ui$Internal$Style$classes.cJ]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aa, $mdgriffith$elm_ui$Internal$Style$classes.cY, $mdgriffith$elm_ui$Internal$Style$classes.cI]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aa, $mdgriffith$elm_ui$Internal$Style$classes.cY, $mdgriffith$elm_ui$Internal$Style$classes.cx]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aa, $mdgriffith$elm_ui$Internal$Style$classes.cY, $mdgriffith$elm_ui$Internal$Style$classes.b$]));
						}
					}())
				]),
			_List_fromArray(
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.bX + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.G + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cg + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ag)),
				A2(
					$elm$core$List$cons,
...
var $author$project$Main$PickCard = {$: 0};
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.as + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.H + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.cW + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bj)))))),
						A2(
							$elm$core$List$cons,
				...
				aK: card.b ? A2(
					...
					_List_fromArray(
						[
							...
							A3($mdgriffith$elm_ui$Element$rgb255, 28, 68, 124))
						]),
					A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
								...
								A3($mdgriffith$elm_ui$Element$rgb255, 193, 53, 56))
							]),
						$mdgriffith$elm_ui$Element$text('?'))),
				aO: clickable ? $elm$core$Maybe$Just(
					$author$project$Main$CardClicked(card.c)) : $elm$core$Maybe$Just($author$project$Main$NoOp)
			});
	});
var $author$project$Main$viewChosenCard = function (card) {
	return A2($author$project$Main$viewCard, true, card);
};
var $author$project$Main$viewCardPickerSection = function (model) {
	var _v0 = model.ax;
	if (!_v0.$) {
		var card = _v0.a;
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Main$viewChosenCard(card),
					A2(
					$mdgriffith$elm_ui$Element$Input$button,
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$centerX]),
					{
						aK: $mdgriffith$elm_ui$Element$text('New Game'),
						aO: $elm$core$Maybe$Just($author$project$Main$PickCard)
					})
				]));
	} else {
		return A2(
			...
			A2(
				...
				_List_fromArray(
					[$mdgriffith$elm_ui$Element$centerX]),
				{
					aK: $mdgriffith$elm_ui$Element$text('Choose Card'),
					aO: $elm$core$Maybe$Just($author$project$Main$PickCard)
				}));
	}
};
...
var $author$project$Main$viewCardRows = function (model) {
	return A2(
		$elm$core$List$map,
		function (cards) {
			return A2(
				...
				A2(
					...
					_List_fromArray(
						[
							A2($mdgriffith$elm_ui$Element$spacingXY, 24, 24)
						]),
					A2(
						$elm$core$List$map,
						$author$project$Main$viewCard(true),
						cards)));
		},
		A2(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$Main$viewCardPickerSection(model)
								])),
							A2(
							$mdgriffith$elm_ui$Element$column,
							_List_fromArray(
							...
							$author$project$Main$viewCardRows(model))
						])))
			]),
		dl: 'Guess Who'
	};
...
var $author$project$Main$main = $elm$browser$Browser$document(
	{cy: $author$project$Main$init, c6: $author$project$Main$subscriptions, dq: $author$project$Main$update, dr: $author$project$Main$view});
